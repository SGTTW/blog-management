  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const postData = {
        title,
        content,
        imageUrl: image ? await uploadImage() : imageUrl,
        author: user.email,
      ...
      <form onSubmit={handleSubmit} className="mb-8">
        ...
        <div className="mb-4">
          ...
          <textarea
            ...
            rows="6"
            required
            placeholder="Use Markdown syntax for formatting: **bold**, *italic*, `code`, > quote [link](url), etc."
          />
        </div>
        ...
        <div className="mb-4">
          ...
          {imageUrl && (
            <div className="mt-2">
              <img src={imageUrl} alt="Preview" className="max-w-xs max-h-40" />
            </div>
          )}
        </div>
